...
contract PendleEUSDESY is PendleERC4626SY, IPTokenWithSupplyCap {
    ...
    constructor(address _susde, uint256 _initialSupplyCap) PendleERC4626SY("SY Ethereal eUSDE", "SY-eUSDE", _susde) {
